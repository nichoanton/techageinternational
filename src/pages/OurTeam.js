...
import { FaUserTie, FaUsers, FaHandshake, FaCog, FaChartLine, FaHeadset } from 'react-icons/fa';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
            Our Recruitment team consists of professionally qualified technical experts who understand 
            client requirements from the right perspective. We specialize in sourcing, identifying, 
            and screening the right candidates through comprehensive pre-interviews to deliver the 
            best talent that perfectly suits our clients' requirements.
          </p>
        </div>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
  {teamMembers.map((member, index) => {
    ...
    return (
      <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
        ...
        <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-6 border-b border-gray-200 flex-shrink-0">
          ...
          <p className="text-blue-600 text-center font-medium text-sm leading-tight">{member.role}</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Team Expertise</h2>
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Combining diverse skills to deliver comprehensive recruitment solutions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Technical Recruitment</h3>
              <p className="text-gray-600 text-sm">
                Expert in identifying and assessing technical talent across industries
              </p>
            </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 text-white">
            <h2 className="text-3xl font-bold mb-4">Partner With Our Expert Team</h2>
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Leverage our team's expertise to find the perfect talent solutions for your organization
            </p>
